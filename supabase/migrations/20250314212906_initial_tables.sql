CREATE TYPE contract_type AS ENUM('contract', 'waiver');--> statement-breakpoint
CREATE TYPE invoice_status AS ENUM('draft', 'paid', 'unpaid', 'uncollectible', 'void');--> statement-breakpoint
CREATE TYPE location_status AS ENUM('incomplete', 'active', 'past_due', 'canceled', 'paused', 'trialing', 'unpaid', 'incomplete_expired');--> statement-breakpoint
CREATE TYPE relationship AS ENUM('parent', 'spouse', 'child', 'sibling', 'other');--> statement-breakpoint
CREATE TYPE package_status AS ENUM('active', 'incomplete', 'expired', 'completed');--> statement-breakpoint
CREATE TYPE payment_method AS ENUM('card', 'cash', 'check', 'zelle', 'venmo', 'paypal', 'apple', 'google');--> statement-breakpoint
CREATE TYPE plan_interval AS ENUM('day', 'week', 'month', 'year');--> statement-breakpoint
CREATE TYPE plan_type AS ENUM('recurring', 'one-time');--> statement-breakpoint
CREATE TYPE reservation_status AS ENUM('active', 'expired', 'canceled');--> statement-breakpoint
CREATE TYPE role_color AS ENUM('red', 'green', 'blue', 'pink', 'cyan', 'lime', 'orange', 'fuchsia', 'sky', 'lemon', 'purple', 'yellow');--> statement-breakpoint
CREATE TYPE transaction_status AS ENUM('paid', 'failed', 'incomplete');--> statement-breakpoint
CREATE TYPE staff_status AS ENUM('active', 'inactive');--> statement-breakpoint
CREATE TYPE support_ticket_status AS ENUM('open', 'updated', 'closed');--> statement-breakpoint
