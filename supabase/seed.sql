...
('sbot_gym', 'acc_test_gym', 'You are a helpful customer support assistant for FitZone Gym. You can help members with their membership status, billing questions, class bookings, and gym-related inquiries. You can create support tickets and escalate complex issues to our staff.', 0.3, 'Hi! I''m the FitZone Support Assistant. I can help with your membership, class schedules, billing questions, and facility information. How can I assist you today?', 'gpt', 'Active', ARRAY[
  '{"name": "get_member_status", "description": "Get member subscription and package status information", "category": "member_info", "parameters": {"type": "object", "properties": {"memberId": {"type": "string", "description": "The member ID to look up"}}, "required": ["memberId"]}}',
  '{"name": "get_member_billing", "description": "Get member billing and payment information", "category": "member_info", "parameters": {"type": "object", "properties": {"memberId": {"type": "string", "description": "The member ID to look up"}}, "required": ["memberId"]}}',
...
('sbot_dance', 'acc_test_dance', 'You are a helpful customer support assistant for Dance Academy. You help students and parents with class information, billing, scheduling, and dance-related questions. You can escalate complex issues to our instructors.', 0.25, 'Hello! I''m the Dance Academy Support Assistant. I can help with class schedules, billing, registration, and dance program information. What would you like to know?', 'gpt', 'Active', ARRAY[
...
('smsg_john_1', 'sconv_john_gym', 'Hi, I have a problem with my billing. I was charged twice this month.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '1 hour'),
...
('smsg_john_4', 'sconv_john_gym', 'I need to speak with someone about this. This is really frustrating.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '20 minutes'),
...
('smsg_john_7', 'sconv_john_gym', 'Thank you! That would be great. I really appreciate the personal attention.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '13 minutes'),

-- Jane's automated resolution
('smsg_jane_1', 'sconv_jane_gym', 'What are your gym hours this week?', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '2 hours'),
...
('smsg_jane_3', 'sconv_jane_gym', 'Perfect, thank you! That''s all I needed.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '2 hours' + INTERVAL '2 minutes'),
...
('smsg_bob_1', 'sconv_bob_dance', 'I think my skill level has improved. Can I move up to a more advanced ballet class?', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '45 minutes'),
...
('smsg_bob_5', 'sconv_bob_dance', 'I''ve been in Ballet Fundamentals for about 6 months. I''ve been working on my positions, basic jumps, and we just started simple adagio combinations.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '25 minutes'),

-- Admin conversation that was handed back (John contacting admin support)
('smsg_admin_1', 'sconv_admin_resolved', 'Hi, I''m a business owner looking to understand your enterprise features. I might need multiple locations under one account.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '3 hours'),
...
('smsg_admin_5', 'sconv_admin_resolved', 'That would be fantastic! Thank you for the personalized assistance.', 'human', 'WebChat', '{}'::jsonb, NOW() - INTERVAL '20 minutes'),
