...
import type { MessageSender, MessageMedia, MessageReaction, EmojiData } from '@/types/chats';
...
export const useSocialChat = ({ 
  ...
  const sendMessage = useCallback(async (
    ...
    try {
      ...
      const api = clientsideApiClient(session.user.sbToken);
      const enrichedMessage = await api.post(`/protected/chats/${currentChatId}/messages`, formData) as any;
