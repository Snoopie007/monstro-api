...
const PackageStatusEnum = pgEnum("package_status", [
  "active",
  "incomplete",
  "expired",
  "completed",
...
const MemberRelationshipEnum = pgEnum("relationship", [
  "parent",
  "spouse",
  "child",
  "sibling",
...
const RoleColorEnum = pgEnum("role_color", [
  "red",
  "green",
  "blue",
  "pink",
...
const ImportedMemberStatusEnum = pgEnum("imported_member_status", [
  "pending",
  "processing",
  "completed",
  "failed",
