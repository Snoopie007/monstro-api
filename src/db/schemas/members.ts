...
export const memberReferrals = pgTable(
  "member_referrals",
  {
    memberId: integer("member_id")
      .notNull()
      .references(() => members.id, { onDelete: "cascade" }),
    referredMemberId: integer("referred_member_id")
      .notNull()
      .references(() => members.id, { onDelete: "cascade" }),
    locationId: integer("location_id")
      .notNull()
...
export const memberContracts = pgTable("member_contracts", {
  ...
  memberId: integer("member_id")
    .notNull()
    .references(() => members.id, { onDelete: "cascade" }),
  templateId: integer("contract_id")
    .notNull()
...
export const memberInvoices = pgTable("member_invoices", {
  ...
  locationId: integer("location_id")
    .notNull()
    .references(() => locations.id, { onDelete: "cascade" }),
  memberPackageId: integer("member_package_id").references(
    () => memberPackages.id,
    { onDelete: "cascade" }
  ),
  memberSubscriptionId: integer("member_subscription_id").references(
...
export const familyMembers = pgTable("family_members", {
  ...
  relatedMemberId: integer("related_member_id").references(() => members.id, {
    onDelete: "cascade",
  }),
