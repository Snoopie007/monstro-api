...
export const triggeredAchievements = pgTable(
  "triggered_achievements",
  {
    ...
    triggerId: integer("trigger_id")
      .references(() => achievementTriggers.id, { onDelete: "cascade" })
      .notNull(),
...
export const triggeredAchievementsRelations = relations(
...
export const achievementTriggersRelations = relations(
  achievementTriggers,
  ({ many }) => ({
