          ...
          <tr>
            <td >
              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                ...
                <tr>
                  <td align="left" class="mj-small-device-button" style="font-size:0; padding: 10px 25px 20px 0; word-break: break-word;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate; line-height: 100%;">
                      <tr>
                        <td align="center" bgcolor="#8708c7" role="presentation" style="border: 1px solid #600469; border-radius: 3px; background: #8708c7; cursor: auto;" valign="middle">
                          <a href="{{ui.buttonUrl}}" style="display: inline-block; color: #ffffff; font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; line-height: 1.25; margin: 0; text-decoration: none; padding: 10px 25px; border-radius: 3px;">
                            {{ui.button}}
                          </a>
                        </td>
                      </tr>
