      ...
      <CalendarDndProvider onEventUpdate={handleEventUpdate}>
        ...
        >
          <div className="flex items-center gap-1 sm:gap-4">
            <Button
              variant="default"
              className="max-[479px]:aspect-square max-[479px]:p-0! border-foreground/10 hover:bg-background/60"
              onClick={handleToday}
            >
              <RiCalendarCheckLine
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="gap-1.5 max-[479px]:h-8 border-foreground/10 hover:bg-background/60">
                  <span>
                    <span className="min-[480px]:hidden" aria-hidden="true">
              ...
              <DropdownMenuContent align="end" className="min-w-32 border-foreground/10">
            ...
            >
              <PlusIcon
                ...
                aria-hidden="true"
              />
              <span className="max-sm:sr-only">New program</span>
            </Button>
          </div>
        </div>
