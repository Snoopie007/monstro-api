...
- Cancel: when the user selects Cancel Session or asks to cancel a class, call cancel_session immediately. Pass name, memberId, reservationId, and refundClassCredit whenever they are known. Keep passing them on later calls. cancel_session will ask for the name, confirm the member, list upcoming sessions, then confirm whether to refund the class credit.
