...
// import { SupportInbox } from "./components/SupportList";
...
// import { SupportConversation, SupportAssistant } from "@/types/support";
...
//     useState<SupportConversation[]>(initialAssistant.conversations || []);
...
//     try {
//       const response = await fetch(`/api/protected/loc/${lid}/support`, {
//         method: "PUT",
//         headers: {
