...
async function fetchMemberProfileData(
	...
	try {
		...
		const pointsSpent = rewardClaims.reduce((total, claim) => {
			return (
				total +
				(claim.previousPoints ? claim.previousPoints - currentPoints : 0)
			);
		}, 0);
				...
				<MemberProvider member={member} paymentMethods={paymentMethods} ml={ml}>
					<div className="grid grid-cols-12 flex-1 gap-4 px-3 py-2 min-h-0">
						...
						<div className="col-span-3 py-4 pr-4 flex flex-col">
							<Tabs
								defaultValue="invoices-transactions"
							...
							>
								...
								>
									<div className="h-full overflow-y-auto space-y-4">
										...
										<MemberTransactionItems params={params} />
									</div>
								</TabsContent>
								<TabsContent
									value="achievements-rewards"
								...
								>
									<div className="h-full overflow-y-auto space-y-4">
										<MemberAchievementItems params={params} />
								...
								>
									<div className="h-full overflow-y-auto">
										<MemberAttendanceItems params={params} />
									</div>
								</TabsContent>
							</Tabs>
						</div>
