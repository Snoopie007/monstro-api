    ...
    <div className="space-y-2">
      ...
      <div className="border-y border-foreground/10">
        <Table className="">
          <TableHeader>
            <TableRow>
              {["Name", "Description", "Points Earned", "Date"].map(
                (header, index) => (
                  <TableHead key={index} className="text-sm h-auto py-2">
                    {header}
                  </TableHead>
                )
              )}
                  ...
                  <TableRow key={i}>
                    <TableCell>
                      <div className="flex flex-row items-center gap-2">
                        ...
                        <div className="text-sm">{ma.achievement?.name}</div>
                      </div>
                    </TableCell>
                    <TableCell>{ma.achievement?.description}</TableCell>
