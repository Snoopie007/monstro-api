    ...
    <div className="space-y-6">
      ...
      <Form {...form}>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="one-off">One-time Invoice</SelectItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>
                    When should this invoice be paid? Leave empty for "due on
                    receipt".
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This description will appear on the invoice sent to the
                    member.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
        ...
        {watchedType === "recurring" && (
          <div className="pt-6">
            <h4 className="text-md font-medium mb-4">Recurring Settings</h4>
