...
import { Avatar, AvatarFallback, Button, DialogBody, DialogFooter } from "@/components/ui";
...
export function SearchMember({ lid, parentId, familyMember, setFamilyMember, reset }: SearchMemberProps) {
