...
export const MonthView = ({ weeks, month, locationId, memberId, onMakeupScheduled }: MonthViewProps) => {
                ...
                {weeks.map((week, weekIndex) => (
                    <div key={weekIndex} className="flex flex-row gap-1 w-full">
                        {week.map((day: DayData, dayIndex: number) => {
                            const hasMissedClasses = day.missedReservations && day.missedReservations.length > 0;
                                            ...
                                            <HoverCardTrigger asChild>
                                                <div
                                                    className={cn(
                                                        ...
                                                        day.count === 0 && !hasMissedClasses &&
                                                        'dark:bg-[#0f172a] bg-[#ebedf0]',
                                                        day.count > 0 &&
                                                        'bg-indigo-700 dark:bg-indigo-500',
                                                        hasMissedClasses && day.count === 0 &&
