  ...
  return (
    <Card className="border-none">
      <CardContent className="px-0">
        <div className="flex justify-start flex-row items-center px-4 py-2 gap-2">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => {
          ...
          <div className="flex flex-initial w-[250px] ">
            <div className="flex flex-col  text-sm gap-1.5 ">
              <div className=" font-bold text-lg ">
                {ml?.firstName || member?.firstName}{" "}
                {ml?.lastName || member?.lastName}
              </div>
              <div className="flex flex-row gap-2 items-center">
                <Mail size={14} />
                <span>{ml?.email || member?.email}</span>
              </div>
              <div className="flex flex-row gap-2 items-center">
                <PhoneCall size={14} />
                <span>{ml?.phone || member?.phone}</span>
              </div>
              <div className="flex flex-row gap-2 items-center">
