...
export function FamilyMemberForm({ familyMember, familyPlans, parent, lid, reset }: FamilyMemberFormProps) {
                    ...
                    <Form {...form}>
                        <form className={cn(
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <Select onValueChange={(value) => field.onChange(value)}>
                                                ...
                                                <SelectContent>
                                                    {RelationshipOptions.map((relation: MemberRelationship, i) => (
                                                        <SelectItem key={i} value={relation}>{relation}</SelectItem>
                                                    ))}
                                                </SelectContent>
                                            </Select>
                                            <FormMessage />
                            ...
                            <fieldset className='space-y-1'>
                                ...
                                />
                                <div className='text-red-500 text-xs  font-medium cursor-pointer' onClick={() => {
