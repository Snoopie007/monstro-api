...
import { InvoiceConfirmStep } from "../../members/[mid]/components/MemberInvoices/InvoiceConfirmStep";
import { InvoiceDetailsStep } from "../../members/[mid]/components/MemberInvoices/InvoiceDetailsStep";
import { InvoiceItemsStep } from "../../members/[mid]/components/MemberInvoices/InvoiceItemsStep";
import { InvoicePreviewStep } from "../../members/[mid]/components/MemberInvoices/InvoicePreviewStep";
...
export default function CreateInvoicePage({ params }: CreateInvoicePageProps) {
	...
	const { data: member, error: memberError } = useSWR(
		`/api/protected/loc/${resolvedParams.id}/members/${memberId}`,
		fetcher,
	);
	...
	const handleComplete = () => {
		router.push(
			`/dashboard/location/${resolvedParams.id}/members/${memberId}?tab=invoices`,
		);
	};
	...
	const handlePreview = async (data: CreateInvoiceFormData) => {
		...
		try {
			...
			const response = await fetch(
				`/api/protected/loc/${resolvedParams.id}/members/${memberId}/invoices/preview`,
				{
					method: "POST",
	...
	const handleCreateInvoice = async (data: CreateInvoiceFormData) => {
		...
		try {
			...
			const response = await fetch(
				`/api/protected/loc/${resolvedParams.id}/members/${memberId}/invoices`,
				{
					method: "POST",
					headers: { "Content-Type": "application/json" },
	...
	const handleSendInvoice = async () => {
		...
		try {
			const response = await fetch(
				`/api/protected/loc/${resolvedParams.id}/members/${memberId}/invoices/${createdInvoice.invoice.id}/send`,
				{ method: "POST" },
			);
