...
function DayItem({
  ...
  return (
    <div
      className={cn(
        "p-1 relative bg-background border-foreground/5 group transition-colors",
    ...
    >
      <div className="text-right flex flex-row justify-end  overflow-hidden">
        <span
          className={cn(
            "inline-block size-6 text-center leading-6 transform transition-transform duration-200 group-hover:-translate-x-7",
