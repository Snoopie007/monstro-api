    ...
    return (
        <div className="flex items-center justify-between py-1.5">
            <div className='flex flex-row gap-4 items-center'>
                ...
                <div className="grid grid-cols-4 items-center border border-foreground/10 rounded-sm bg-background">
            ...
            <div className="flex-initial gap-2 pr-4">
                <ToggleGroup type="single" className='border border-foreground/10 rounded-sm gap-0 bg-background'
                    value={view}
