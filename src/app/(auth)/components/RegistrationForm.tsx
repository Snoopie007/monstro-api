                ...
                <form onSubmit={form.handleSubmit(registerUser)} className="space-y-4">
                    <fieldset className="grid grid-cols-2 gap-2">
                        <FormField control={form.control} name="firstName" render={({ field }) => (
                            <FormItem className="col-span-1">
                                ...
                                <FormControl>
                                    <Input type="text" className={InputStyle} placeholder="First Name" disabled={emailParam ? true : false} {...field} />
                                </FormControl>
                    ...
                    <fieldset>
                        <FormField control={form.control} name="email" render={({ field }) => (
                            <FormItem>
                                <FormControl>
                                    <Input type="email" className={InputStyle} placeholder="Email" disabled={emailParam ? true : false} {...field} />
                                </FormControl>
                                <FormMessage className="text-xs" />
                            </FormItem>
                        )} />
                        ...
                        <div className="flex-1 justify-center space-y-2">
                            ...
                            <div className="flex  flex-row gap-1">
                                <Select onValueChange={(value: string) => { setPhoneRegion(value as CountryCode) }} defaultValue={phoneRegion}>
                                    ...
                                    <SelectTrigger className={cn(InputStyle, "w-[22%]")} >
                                    ...
                                    render={({ field: { onChange, value } }) => (
                                        <FormItem className="flex-1">
                                            <FormControl >
                                                <PhoneInput
                                                    type="tel"
                                                    className={cn(InputStyle, "bg-transparent inline-block w-full border py-1.5 px-4")}
                                                    value={value}
                    ...
                    <fieldset>
                        <FormField control={form.control} name="password" render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type="password" className={InputStyle} placeholder="Password" {...field} />
                                </FormControl>
                                <FormMessage className="text-xs" />
                            </FormItem>
                        )} />
                    ...
                    <fieldset>
                        <div className="flex flex-row items-start space-x-3 space-y-0">
                            ...
                            <label className="leading-6 -mt-1">
                                ...
                                <Link href={"https://www.monstro-x.com/legal/term-of-use"} className={" text-indigo-500 inline-block"} target="_blank">
                                    Terms of service
                                </Link> and {" "}
                                <Link href={"https://www.monstro-x.com/legal/privacy-policy"} className={" text-indigo-500 inline-block"} target="_blank">
                                    Privacy policy
                                </Link>.
                            </label>
                        </div>
                    ...
                    <div className="flex ">
                        <Button
                            size="lg"
                            className={cn("children:hidden bg-indigo-600 text-white ",
