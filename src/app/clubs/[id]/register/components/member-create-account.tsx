            ...
            <form onSubmit={form.handleSubmit(registerUser)} className="space-y-2">
                ...
                <fieldset>
                    <FormField control={form.control} name="email" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input variant="register" type="email" placeholder="Your email" disabled={emailParam ? true : false} {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                ...
                <fieldset>
                    <FormField control={form.control} name="phone" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input variant="register" type="text" placeholder="Your Phone" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                ...
                <fieldset>
                    <FormField control={form.control} name="password" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input variant="register" type="password" placeholder="Your password" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                ...
                <fieldset>
                    <FormField control={form.control} name="confirmPassword" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input variant="register" type="password" placeholder="Confirm your password" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                ...
                <fieldset>
                    <FormField control={form.control} name="referralCode" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input variant="register" type="text" placeholder="Enter the referral Code" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                ...
                <div className={"pt-2"}>
                    ...
                    <p className="mt-2 text-black/80 text-base text-center">
                        ...
                        <Link href={"#"} className={" text-indigo-700 font-semibold text-base inline-block"}>Terms of service</Link>.
                    </p>
                </div>
            </form>
        </Form>
