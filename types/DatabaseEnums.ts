...
export type VenueMode = 'location' | 'custom';
export type EventTicketPricingMethod = 'free' | 'fixed';
export type EventTicketStatus = 'active' | 'closed';
export type EventRegistrationStatus = 'pending' | 'registered' | 'cancelled' | 'attended';
