...
export const TransactionStatusEnum = pgEnum("transaction_status", ["paid", "failed", "disputed"]);
...
export const MigrateStatusEnum = pgEnum("migrate_status", ["pending", "completed", "failed"]);
